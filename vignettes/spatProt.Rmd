...
bounds <- unlist(SummarizedExperiment::colData(spe.plot)[1, c(
    "x_origin",
    "y_origin",
    "x_max",
    "y_max"
...
sizes <- unlist(SummarizedExperiment::colData(spe.plot)[1, c(
    "spot_width",
    "spot_height"
)])
