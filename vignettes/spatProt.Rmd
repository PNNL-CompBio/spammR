...
```{r omics data}
download.file("https://figshare.com/ndownloader/files/55158821",method='wget',
              quiet=TRUE, dest='pdl.rda')
load('pdl.rda')
...
secprots<-subset(ora.res,krbpaths=='REACTOME_GLUCOSE_REGULATION_OF_INSULIN_SECRETION')|>
