...
K00005 (glycerol dehydrogenase) being one of the "upregulated KOs" we can visualize the abundances across the different sampling locations with `spammr::spatial_heatmap()`
...
```{r}
ora.res <- spammR::enrich_ora(diff_ex, geneset = keggPathwayToKo, geneset_name = "KEGG pathways", feature_column = "KO", pval_thresh = 0.1)
print(head(ora.res))
```
