...
We can also compute the correlation of the lipids. If we use the reduced
object, it will be faster, and features more correlated.

```{r lipid networks}


lg <- spatial_network(mspe, assay_names = 'lipids',
                      feature_names = 'Name', lowest_thresh = 0.6)


lg <- spatial_network(reduced, assay_names = 'lipids',
                      feature_names = 'Name', lowest_thresh = 0.9, 
                      top_edges=4000)
```
