...
#'  for filtering spatialDiffEx results. Default is NA
#' @param logFC_upperThresh Upper threshold for log Fold Change, to be used
#'  for filtering spatialDiffEx results. Default is NA
...
enrich_ora <- function(spe,
                       geneset,
                       feature_column, # feature for gene set mapping
